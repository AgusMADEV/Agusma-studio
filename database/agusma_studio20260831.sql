...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-08-2026 a las 09:46:12
...
(19, 8, 'hero', 'hero', '125 years of legacy', '125 years of legacy', NULL, '{\"layout\":\"full_bleed\",\"height\":\"viewport\",\"image_position\":\"right\",\"fit\":\"cover\",\"position\":\"center\",\"overlay\":\"dark\",\"alignment\":\"center\",\"show_entity\":true,\"show_tags\":true,\"show_actions\":true}', 1, 1, '2026-08-07 07:41:12', '2026-08-07 07:41:12');
...
(1, 'Heritage Template', 'heritage-template', 'Editorial template built for commemorative collection pages with a heritage narrative, timeline, gallery and feature-story sections.', './assets/images/hero-125.png', 0, 0, '2026-08-05 08:00:02', '2026-08-07 06:07:50'),
(2, 'Real Madrid 2026/27 Template', 'real-madrid-2026-27-template', 'A full seasonal kit program for Real Madrid.', './assets/images/milanAW.png', 1, 1, '2026-08-07 06:09:19', '2026-08-07 07:02:02');
...
--
-- Volcado de datos para la tabla `collection_template_sections`
--

INSERT INTO `collection_template_sections` (`id`, `template_id`, `section_key`, `section_type`, `eyebrow`, `title`, `body`, `settings_json`, `display_order`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 2, 'hero', 'hero', 'Football · Real Madrid CF', 'Real Madrid 2026/27', 'Real Madrid 2026/27 structures the club into a complete collection architecture with separate pieces for each kit expression.', '{\"layout\":\"split\",\"height\":\"viewport\",\"image_position\":\"right\",\"fit\":\"cover\",\"position\":\"top\",\"overlay\":\"none\",\"alignment\":\"left\",\"show_entity\":true,\"show_tags\":true,\"show_actions\":true}', 1, 1, '2026-08-07 06:09:19', '2026-08-07 06:09:19'),
(2, 2, 'concept', 'intro', 'The concept', 'A new interpretation of tradition', 'Esta colección reinterpreta la identidad histórica del club mediante...', '{\"alignment\":\"center\",\"content_width\":\"wide\",\"variant\":\"default\",\"spacing\":\"compact\"}', 2, 1, '2026-08-07 06:09:19', '2026-08-07 06:09:19'),
(3, 2, 'collection-pieces', 'pieces', 'The collection', 'Explore the designs', NULL, '{\"layout\":\"grid\",\"columns\":\"3\",\"image_ratio\":\"landscape\",\"gap\":\"normal\",\"variant\":\"default\",\"show_piece_type\":true,\"show_description\":true}', 3, 1, '2026-08-07 06:09:19', '2026-08-07 06:09:19'),
(4, 2, 'gallery', 'gallery', 'Gallery', 'The collection in a visual', NULL, '{\"layout\":\"carousel\",\"columns\":\"3\",\"image_ratio\":\"portrait\",\"gap\":\"normal\",\"variant\":\"default\",\"show_captions\":true}', 4, 1, '2026-08-07 06:09:19', '2026-08-07 06:09:19'),
(5, 2, 'image', 'full_image', '125 years of legacy', NULL, NULL, '{\"height\":\"half\",\"fit\":\"cover\",\"position\":\"center\",\"overlay\":\"dark\",\"copy_position\":\"bottom-center\"}', 5, 1, '2026-08-07 06:09:19', '2026-08-07 06:09:19'),
(6, 2, 'materials', 'technical_details', 'Construction', 'Materials and finishes', 'Poliéster técnico micro-piqué, emblemas multicapa y acabados...', '{\"layout\":\"stacked\",\"columns\":\"1\",\"alignment\":\"left\",\"variant\":\"dark\"}', 6, 1, '2026-08-07 06:09:19', '2026-08-07 06:09:19');
...
(1, 1, 'Real Madrid CF', 'real-madrid', 'club', 'Club entity', 'Historic club concepts and seasonal kit systems.', 'Real Madrid acts as the flagship club entity inside Football, ready to host full seasonal collections and individual pieces.', './assets/images/real-madrid-mono.svg', NULL, '#d9c7a4', '#ffffff', '#f6f1e6', '#111111', 1, 1, 1, '2026-07-25 14:29:07', '2026-08-12 23:42:42'),
(2, 1, 'Portugal', 'portugal', 'national_team', 'National team entity', 'National team capsules and player-led editorial collections.', 'Portugal represents the national-team branch inside Football and replaces National Teams as a standalone category.', './assets/images/portugal-mono.svg', NULL, '#9f2033', '#d4af37', '#f5ece8', '#111111', 2, 1, 1, '2026-07-25 14:29:07', '2026-08-07 07:44:12'),
...
(7, 1, 'F.C. Barcelona', 'barcelona', 'club', 'Club entity', 'Historic corrupt club concepts and seasonal kit systems.', 'FC Barcelona acts as the flagship club entity inside Football, ready to host full seasonal collections and individual pieces.', './assets/images/barcelona-mono.svg', NULL, NULL, NULL, NULL, NULL, 0, 0, 1, '2026-07-25 16:17:51', '2026-08-09 21:32:35'),
(12, 1, 'Spain', 'spain', 'national_team', NULL, NULL, NULL, './assets/images/spain-mono.svg', NULL, NULL, NULL, NULL, NULL, 0, 1, 1, '2026-08-07 07:49:05', '2026-08-07 07:49:21'),
(13, 1, 'Bayern de Múnich', 'beyern-munich', 'club', NULL, NULL, NULL, './assets/images/bayern-mono.svg', NULL, NULL, NULL, NULL, NULL, 0, 0, 1, '2026-08-09 21:29:11', '2026-08-09 21:29:11'),
(14, 1, 'Manchester United F.C.', 'man-united', 'club', NULL, NULL, NULL, './assets/images/man-united-mono.svg', NULL, NULL, NULL, NULL, NULL, 0, 0, 1, '2026-08-09 21:31:20', '2026-08-09 21:31:20'),
(15, 1, 'Arsenal F.C.', 'arsenal', 'club', NULL, NULL, NULL, './assets/images/arsenal-mono.svg', NULL, NULL, NULL, NULL, NULL, 0, 0, 1, '2026-08-09 21:32:13', '2026-08-09 21:32:13'),
(16, 1, 'Chelsea F.C.', 'chelsea', 'club', NULL, NULL, NULL, './assets/images/chelsea-mono.svg', NULL, NULL, NULL, NULL, NULL, 0, 0, 1, '2026-08-09 21:33:28', '2026-08-09 21:33:28'),
(17, 1, 'Liverpool F.C.', 'liverpool', 'club', NULL, NULL, NULL, './assets/images/liverpool-mono.svg', NULL, NULL, NULL, NULL, NULL, 0, 0, 1, '2026-08-12 23:32:59', '2026-08-12 23:33:45');
